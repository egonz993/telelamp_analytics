...
getAnalysis(100, 2000, (devices) => {         //getAnalysis(t, limit, callcack)
    ...
    console.log("- OVERFLOW:", overflows.length, "--> Warning: ", overflows_warning.length, "| Danger: ", overflows.length, "| Error: ", overflows_error.length)
